...
add_rings -layer {top M3 bottom M3 left M4 right M4} -jog_distance 2.5 -nets {gnd vdd} -threshold 2.5 -width 0.44 -spacing 0.46 -offset 0.315
...
##Add power stripes
add_stripes -block_ring_top_layer_limit M5 -max_same_layer_jog_length 6 -pad_core_ring_bottom_layer_limit M3 -set_to_set_distance 25 -pad_core_ring_top_layer_limit M5 -spacing 6 -merge_stripes_value 2.5 -layer M4 -block_ring_bottom_layer_limit M3 -width 0.5 -nets {gnd vdd}
